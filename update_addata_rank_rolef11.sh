...
echo '
{
    ...
    "jdbc" : {
        ...
        "sql" : [ { 
          "statement" : "SELECT ar.id,ar.id as _id,ad.attribute04 ,ad.material ,ad.attribute06,a.parent_area as a_p_area,a.child_area as a_c_area, p.parent_area as p_p_area,p.child_area as p_c_area , ar.ad_id,ar.md5,ar.subject_md5,ar.advertiser,ar.advertiser as advertiser_na,ar.trackers,ar.trackers as trackers_na,CONCAT(\"[\",replace(ar.trackers_list,\";\",\",\"),\"]\") as tracker_list,ar.tags ,ar.tags as tags_na,CONCAT(\"[\",replace(ar.tags,\";\",\",\"),\"]\") as tag_list,ar.publisher,ar.publisher as publisher_na,ar.width,ar.height,ar.wharea,ar.role,ar.date5,ar.title,ar.size,ar.type,ar.shape,ar.score,ar.platform,ar.ids_items,ar.max_ids_items,ar.screen_ratio,ar.area_ratio,ar.range_type,ar.created_date from addata_rank_role as ar LEFT JOIN domains as a ON a.host= ar.advertiser LEFT JOIN domains as p ON p.host= ar.publisher LEFT JOIN addata as ad on ar.ad_id=ad.id where ar.id>?",
          "parameter" : '${num}'
        } ],
        "index" : "rank_role_v11",
        "type" : "addata_index",
