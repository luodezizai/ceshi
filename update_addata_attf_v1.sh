...
echo '
{
    ...
    "jdbc" : {
        ...
        "sql" : [ { 
          "statement" : "SELECT addata.id,id as _id,IF((addata.platform=\"\" || addata.platform is NULL) || (( addata.platform=1 || addata.platform=4 ) && (addata.attribute07=\"\" || addata.attribute07 is NULL || left(addata.attribute07,1)!=\"{\" || right(addata.attribute07,1)!=\"}\")) || (addata.platform=2),\"{'width':0,'height':0}\",addata.attribute07) as attribute07 from addata WHERE addata.id>?",
          "parameter" : '${num}'
        } ],
        "index" : "addata_attr7_v1",
        "type" : "addata_index",
        "elasticsearch" : {
            "cluster" : "adbuges2",
            "host" : "192.168.1.47",
